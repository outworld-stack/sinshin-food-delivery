...
export const PaymentSection = memo(function PaymentSection({
  ...
  return (
    <div className="bg-white dark:bg-[#2a1015] p-6 rounded-2xl border border-gray-200 dark:border-[#3a151c] shadow-sm">
      ...
      <div className={`flex items-center justify-between p-4 rounded-xl border-2 mb-4 transition ${useWallet ? 'border-primary dark:border-dark-primary bg-primary/5 dark:bg-dark-primary/5' : 'border-gray-200 dark:border-[#3a151c]'
